...
class CancelChatInvitationRequest(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.SET:
                    ...
                    for _i18 in range(_size14):
                        ...
                        self.targetUserMids.add(_elem19)
                    iprot.readSetEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.targetUserMids is not None:
            oprot.writeFieldBegin('targetUserMids', TType.SET, 3)
            oprot.writeSetBegin(TType.STRING, len(self.targetUserMids))
            for iter20 in self.targetUserMids:
...
class DeleteOtherFromChatRequest(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.SET:
                    ...
                    for _i25 in range(_size21):
                        ...
                        self.targetUserMids.add(_elem26)
                    iprot.readSetEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.targetUserMids is not None:
            oprot.writeFieldBegin('targetUserMids', TType.SET, 3)
            oprot.writeSetBegin(TType.STRING, len(self.targetUserMids))
            for iter27 in self.targetUserMids:
...
class GroupExtra(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i53 in range(_size49):
                        ...
                        self.inviteeMids[_key54] = _val55
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.memberMids is not None:
            ...
            for kiter56, viter57 in self.memberMids.items():
...
class Message(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i73 in range(_size69):
                        ...
                        self.contentMetadata[_key74] = _val75
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 19:
    ...
    def write(self, oprot):
        ...
        if self.contentMetadata is not None:
            ...
            for kiter82, viter83 in self.contentMetadata.items():
...
class Profile(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i89 in range(_size85):
                        ...
                        self.statusMessageContentMetadata[_key90] = _val91
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 37:
    ...
    def write(self, oprot):
        ...
        if self.statusMessageContentMetadata is not None:
            ...
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.statusMessageContentMetadata))
            for kiter92, viter93 in self.statusMessageContentMetadata.items():
...
class SyncRelations(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i98 in range(_size94):
                        _elem99 = SyncParamContact()
                        _elem99.read(iprot)
                        self.syncParamContact.append(_elem99)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.LIST:
                    ...
                    for _i104 in range(_size100):
                        _elem105 = SyncParamMid()
                        _elem105.read(iprot)
                        self.syncParamMid.append(_elem105)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.syncParamContact is not None:
            ...
            for iter106 in self.syncParamContact:
                iter106.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.syncParamMid is not None:
            ...
            for iter107 in self.syncParamMid:
                iter107.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i112 in range(_size108):
                        ...
                        self.parameterMap[_key113] = _val114
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
